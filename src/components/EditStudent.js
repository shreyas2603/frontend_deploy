...
function EditStudent()
{
    ...
    useEffect(()=>{
        Axios.get("https://complete-deployment2.onrender.com/students/update-student/" + id)
        .then((res)=>{
            if(res.status === 200){
    ...
    const handleSubmit = () => {
        ...
        Axios.put("https://complete-deployment2.onrender.com/students/update-student/" + id , newObj)
        .then((res)=>{
            if(res.status === 200){
